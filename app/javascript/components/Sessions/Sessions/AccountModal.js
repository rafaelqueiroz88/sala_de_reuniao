                ...
                <Modal.Body>
                    <div className="form-group row">
                        ...
                        <div className="col-xs-7 col-sm-7 col-md-6">
                            <input type="text" onChange={props.handleNewChange} className="form-control" name="name" id="name" placeholder="João..." />
                        </div>
                    </div>
                    <div className="form-group row">
                        <label htmlFor="occupation" className={"col-xs-3 col-sm-3 col-md-2 col-form-label"}>Cargo:</label>
                        <div className="col-xs-7 col-sm-7 col-md-6">
                            <input type="text" onChange={props.handleNewChange} className="form-control" name="occupation" id="occupation" placeholder="Analista de Sistemas" />
                        </div>
                    </div>
                    <div className="form-group row">
                        <label htmlFor="email" className={"col-xs-3 col-sm-3 col-md-2 col-form-label"}>E-mail:</label>
                        <div className="col-xs-7 col-sm-7 col-md-6">
                            <input type="text" onChange={props.handleNewChange} className="form-control" name="email" id="email" placeholder="seu_nome@exemplo.com" />
                        </div>
                    </div>
                    <div className="form-group row">
                        <label htmlFor="password" className={"col-xs-3 col-sm-3 col-md-2 col-form-label"}>Senha: </label>
                        <div className="col-xs-7 col-sm-7 col-md-6">
                            <input type="password" onChange={props.handleNewChange} className="form-control" name="password" id="password" placeholder="******" />
                        </div>
                    </div>
                    <div className="form-group row">
                        <label htmlFor="confirmPassword" className={"col-xs-3 col-sm-3 col-md-2 col-form-label"}>Confirmar: </label>
                        <div className="col-xs-7 col-sm-7 col-md-6">
                            <input type="password" className="form-control" name="confirmPassword" id="confirmPassword" placeholder="******" />
                        </div>
                    </div>
                </Modal.Body>
                <Modal.Footer>
